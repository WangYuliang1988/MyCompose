package com.compose.theme.data

import androidx.annotation.DrawableRes
import androidx.compose.runtime.Immutable
import com.compose.theme.R

// Immutable is used by composition which enables composition optimizations that
// can be performed based on the assumption that values read from the type will not change.
// data classes that only contain val properties that do not have custom getters can
// safely be marked as Immutable if the types of properties are either primitive types or also Immutable.
@Immutable
data class Post(
    val id: Long,
    val title: String,
