...
fun StaggeredGrid(
    ...
    Layout(
        ...
        measurePolicy = MeasurePolicy { measurables, constraints ->
            // Measure and position children given constriants logic here
            ...
            val placeables = measurables.mapIndexed { index, measurable ->
                ...
                val row = index % rows // index maybe larger than rows
                rowWidths[row] += placeable.width // Each row's width is the sum of its children's width
                rowHeights[row] = max(rowHeights[row], placeable.height)

                placeable // The item contained in the result list
            }
